...
public class FileEncodingDetect {
	private final static String TAG = "decodeTest_FileEncodingDetect";
	private static final int INDEX_GB2312 = 0; 
	private static final int INDEX_ASCII = 1; 
    private static final int INDEX_UTF8 = 2; 
    private static final int INDEX_UNICODE = 3; 
    private static final int INDEX_GBK = 4; 
    //private static final int INDEX_HZ = 5; 
    //private static final int INDEX_BIG5 = 6; 
    //private static final int INDEX_EUC_TW = 7; 
    //private static final int INDEX_ISO_2022_CN = 8; 
    private static final int TOTAL_ENCODINGS = 5; 
    ...
    private static final String ENCODE_UNICODE = "Unicode"; 
    private static final String ENCODE_ASCII = "ASCII"; 
    private static final String ENCODE_HZ = "HZ";
    private static final String ENCODE_BIG5 = "BIG5";
    private static final String ENCODE_CNS11643 = "CNS11643";
    private static final String ENCODE_ISO2022CN = "ISO2022CN";
    ...
    //private int UnicodeFreq[94][128]; 
    
    private String[] codings; 
    private static FileEncodingDetect instance=null;
    
    public static FileEncodingDetect getInstance(){
		if(instance==null){
			instance = new FileEncodingDetect();
		}
		return instance;
	}
 
    private FileEncodingDetect() { 
    ...
    private void initEncodingFormat(){ 
        ...
        codings[INDEX_GB2312] = ENCODE_GB2312; 
        codings[INDEX_GBK] = ENCODE_GBK; 
        //codings[INDEX_HZ] = ENCODE_HZ; 
        //codings[INDEX_BIG5] = ENCODE_BIG5; 
        //codings[INDEX_EUC_TW] = ENCODE_CNS11643; 
        //codings[INDEX_ISO_2022_CN] = ENCODE_ISO2022CN; 
        codings[INDEX_UTF8] = ENCODE_UTF8; 
        codings[INDEX_UNICODE] = ENCODE_UNICODE; 
        codings[INDEX_ASCII] = ENCODE_ASCII; 
    } 
    ...
    public String detectEncoding(URL testurl) { 
        ...
        String guess = codings[INDEX_GB2312]; 
    ...
    public String detectEncoding(byte[] rawtext) { 
        ...
        int encoding_guess = INDEX_ASCII; 
        String encoding = ENCODE_GB18030;
        
        long start = System.currentTimeMillis();	
        
        scores = new int[TOTAL_ENCODINGS]; 
        for(int i=0; i<TOTAL_ENCODINGS; i++){
        	scores[i] = 0;
        }
 
        // Assign Scores 
        scores[INDEX_GB2312] = gb2312_probability(rawtext); 
        scores[INDEX_GBK] = gbk_probability(rawtext); 
        //scores[INDEX_HZ] = hz_probability(rawtext); 
        //scores[INDEX_BIG5] = big5_probability(rawtext); 
        //scores[INDEX_EUC_TW] = euc_tw_probability(rawtext); 
        //scores[INDEX_ISO_2022_CN] = iso_2022_cn_probability(rawtext); 
        scores[INDEX_UTF8] = utf8_probability(rawtext); 
        scores[INDEX_UNICODE] = utf16_probability(rawtext); 
        scores[INDEX_ASCII] = ascii_probability(rawtext); 
        
        Log.i(TAG,Util.getMethodLine()+"rate:GB2312="+scores[INDEX_GB2312]+",GBK="+scores[INDEX_GBK]+",UTF8="+scores[INDEX_UTF8]+
        		",UNICODE="+scores[INDEX_UNICODE]+",ASCII="+scores[INDEX_ASCII]);
        ...
        if (maxscore <= 50) { 
            encoding = ENCODE_GB18030;
        } else{
        	encoding = codings[encoding_guess];
        }
        
        long end = System.currentTimeMillis();
        Log.i(TAG,Util.getMethodLine()+"encoding="+encoding+",detectEncoding time="+(end-start));
        return encoding; 
    } 
    ...
    private int iso_2022_cn_probability(byte[] rawtext) { 
        int i, rawtextlen = 0; 
    ...
    private int utf16_probability(byte[] rawtext) { 
        // int score = 0; 
        // int i, rawtextlen = 0; 
        // int goodbytes = 0, asciibytes = 0; 
